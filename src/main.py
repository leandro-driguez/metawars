...
Unit.save_army(test_left_army, "../data/test_left_army.json")
test_left_army = Unit.load_army("../data/test_left_army.json")
...
Unit.save_army(test_right_army, "../data/test_right_army.json")
test_right_army = Unit.load_army("../data/test_right_army.json")
